...
Since the true $\lambda(\cdot)$s in equation \eqref{eq:tobit2_2step}
are generally unknown,
they are replaced by estimated values based on the probit estimation
in the first step.
...
Do you agree with this division of tasks?
