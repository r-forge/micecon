...
\code{summary} and \code{print.summary} methods calculate and print
summary results,
\code{coef} and \code{coef.summary} methods extract the estimated coefficients,
...
The \code{coef}, \code{coef.summary}, \code{vcov}, and \code{print.summary}
methods include an extra argument \code{part},
