...
pseudo-randomisation (natural experiments) has become the state-of-the-art
for estimating the causal effects.  However, methods relying on
...
It consists of the following (unobserved) structural model:
\begin{align}
