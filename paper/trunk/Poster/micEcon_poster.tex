...
°Almost Ideal Demand System° (AIDS)}}\\[5mm]
{\standardfontsize
...
°Symmetric Normalized Quadratic° (SNQ) profit function}}\\[5mm]
{\standardfontsize
The SNQ profit function is often used in microeconomic production models
because it enables the imposition of global convexity.
\texttt{micEcon} provides functions for:
\begin{itemize}
\item econometric estimation
\item imposition of global convexity using a recent two-step estimation
   procedure
...
\posterbox{0.92\textwidth}{}{linewidth=2mm, framearc=0.1,
   ...
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Heckman Selection Models}}\\[5mm]
{\standardfontsize
If a non-random (sub)sample is used for econometric estimation,
...
\posterbox{0.92\textwidth}{}{linewidth=2mm, framearc=0.1,
   ...
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Tools for Matrices}}\\[5mm]
{\standardfontsize
\texttt{micEcon} provides functions for:
\medskip
\begin{itemize}
...
\posterbox{0.92\textwidth}{}{linewidth=2mm, framearc=0.1,
   ...
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Miscellaneous Tools}}\\[5mm]
{\standardfontsize
\texttt{micEcon} provides functions for:
\medskip
\begin{itemize}
